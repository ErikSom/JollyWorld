...
const gameProps = ["levelStartTime","levelWon","gameOver","checkPointData","selectedCharacter", "openMainMenu", "runWorld", "playWorld", "findPlayableCharacter", "testWorld", "playLevelMidi", "stopTestingWorld", "resetWorld", "stopWorld", "openEditor", "initLevel", "pauseGame", "unpauseGame", "resetGame", "doAutoSave", "stopAutoSave", "saveNewLevelData", "saveLevelData", "publishLevelData", "deleteLevelData", "levelHasChanges", "currentLevelData", "gameCheckpoint", "gameWin", "gameLose", "loadUserLevelData", "loadPublishedLevelData", "gameRender", "gameCamera", "gameUpdate", "voteLevel", "prepareGameFonts", "toggleMute", "GAMESTATE_MENU", "GAMESTATE_EDITOR", "GAMESTATE_NORMALPLAY", "GAMESTATE_LOADINGDATA", "gameInit", "timeFormat"];
const triggerProps = ["ACTION_GAME_WIN", "ACTION_GAME_LOSE"]
const uiProps = ["showMainMenu", "mainMenuResize", "handleLoginChange", "setMainMenuCharacterImage", "setLevelDataOnGameTile", "determineMainMenuFilter", "reloadMainMenuGames", "showLevelBanner", "enableVoteButtons", "setLevelBannerData", "hideLevelBanner", "showLoginPrompt", "openDiscordOauth", "showSmallLogo", "hideSmallLogo", "hideMainMenu", "showGameOver", "hideGameOverMenu", "showCharacterSelect", "hideCharacterSelect", "playLevelFromMainMenu", "showVehicleSelect", "hideVehicleSelect", "showPauseMenu", "hidePauseMenu", "showWinScreen", "hideWinScreen", "buildSocialShare", "updateSocialShareLinks", "showYouTubePlayer", "hideYouTubePlayer", "shouldShowVoteButton"]
