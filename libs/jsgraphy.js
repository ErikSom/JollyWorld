(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.JSGraphy = factory());
  ...
  var JSGraphy = /*#__PURE__*/function () {
    function JSGraphy() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      _classCallCheck(this, JSGraphy);
    ...
    _createClass(JSGraphy, [{
      ...
      value: function begin(label, color) {
        ...
        if (label !== 'ms' && !this.labelColors[label]) {
          // register new label
          this.labelColors[label] = color || "#".concat(Math.floor(Math.random() * 16777215).toString(16));
