...
export var Settings = {
    ...
    vehicleLayers:{'Bike':68, 'DirtBike':74, 'NoVehicle':50, 'Skateboard':67, 'Skippyball':91}, // we need the layers if we want to be able to switch vehicles, so we can correct the level
    /*EDITOR*/
