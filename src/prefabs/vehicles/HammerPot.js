...
class HammerPot extends BaseVehicle {
    ...
    init() {
        ...
        this.moveJoint.SetMaxMotorForce(5000);
    ...
    update() {
        ...
        if(Key.isDown(Key.LEFT)){
            ...
            this.rotateJoint.SetMotorSpeed(5);
        }else if(Key.isDown(Key.RIGHT)){
            this.rotateJoint.EnableMotor(true);
            this.rotateJoint.SetMotorSpeed(-5);
        }else{
            this.rotateJoint.EnableMotor(false);
        }

        if(Key.isDown(Key.UP)){
            this.moveJoint.SetMotorSpeed(-20);
