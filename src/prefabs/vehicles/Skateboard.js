...
class Skateboard extends BaseVehicle {
    ...
    update() {
        ...
        if(this.accel != 0){
            ...
            // console.log("globalFrame:", globalFrame.x, globalFrame.y);
