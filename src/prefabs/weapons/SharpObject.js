    ...
    update(){
                ...
                sides.forEach(side =>{
                    ...
                    for(let j = 0; j<numSpreadParts; j++){
                        ...
                        if (callback.m_hit) {
                            ...
                            game.editor.queueDecalToBody(body, callback.m_point, "Decal.png", true, 0.5);
                            game.editor.queueDecalToBody(sharpBody, callback.m_point, "Decal.png", false, 1.3);
        ...
        if(this.bodiesToSeperate.length>0){
            for(var i = 0; i<this.bodiesToSeperate.length; i++){
                ...
                if(!joint) continue;
                if(joint.isSharpJoint) game.editor.DestroyJoint(joint);
