...
export const HELP = {
	select: `<p>With the selection tool you can select objects by clicking them or dragging a box around multiple objects. Click next to the selection box or press escape to deselect an object. Hold SHIFT and click objects to add them to the selection and hold CTRL to remove objects from the selection.<br /><strong></strong></p>
	<p><strong>Tips:</strong></p>
	<ul>
	<li>You can switch most object between being a <em><strong>Graphic</strong></em> or <em><strong>Body</strong></em>. Graphics are static objects that don't move by themselves. Bodies take place in the physics world and will collide with other Bodies, you can recognise them by the moving green outline. You can group a Graphic together with a Body to make the Graphic follow the Body.</li>
	<li>Double clicking any Graphic or Body will allow you to edit the vertices of this object.</li>
	...
	<li><strong><em>awake</em>:<br /></strong>Fixed objects are always asleep. Objects that move can be set to sleep by toggling away to off. If a Body sleeps it will only start moving once its touched by another Body, this way it can float in the air.<br /><br /></li>
	...
	<p><em><strong>ARROWS &amp; Mouse Drag</strong></em> - Moves the object(s)<br /><em><strong>WASD</strong></em> - Grow or shrink the object(s)<br /><strong><em>Z &amp; X</em> </strong>- Rotate objects (hold ALT for rotating multiple objects around center)<br /><em><strong>DELETE &amp; BACKSPACE</strong></em> - Destroy object(s)<br /><em><strong>T</strong></em> - Start / Stop testing level<br /><em><strong>CTRL + Z</strong></em> - Undo last action<strong></strong><em><strong><br />CTRL + G</strong></em> - Group / Ungroup objects<br /><em><strong>CTRL + J</strong></em> - Place Joint (With 2 objects selected it will connect those 2 objects with the joint, one object selected will be pinned to the background)<br /><em><strong>CTRL + UP/DOWN</strong></em> - Move object a layer up or down<br /><em><strong>SHIFT</strong></em> - Holding shift will speed up rotating, scaling and moving with the keyboard<br /><em><strong>SPACE</strong></em> - Hold space to drag the camera by dragging the mouse, double tap space to reset the camera to the player<br /><em><strong>+- </strong></em>- You can zoom the screen by pressing plus or minus<br /><strong><em>Mouse Wheel </em></strong>- zooms the screen<br /><b><i>1-9 - </i></b><i>select the editor tools ( 1 is select tool, 2 geometry tool, etc.)</i></p>​​`,
	...
	<li>Double clicking any Graphic or Body using the select tool to edit the vertices.</li>
	</ul>`,
	pen:`<p>The Pen tool is similar to the curvature tool from Adobe Illustrator or the Pen Tool from Photoshop. It allows artists to easily create beautiful curves and shapes once you get the hang of it.</p>
	<ul>
	<li><em><strong>Mouse Drag:</strong></em> Holding the mouse button down while dragging will create a curved vertice, move the mouse around to see where the curve is going</li>
	<li>Clicking without dragging will create a vertice with no curve</li>
	<li>You can always tweak the curves later by double clicking the graphic to go into vertice editing mode</li>
	</ul>
	<p><em><strong>BACKSPACE &amp; CTRL+Z - </strong></em>remove last placed vertice</p>`,
	...
	<ul>
	<li><em><strong>Pin:<br /></strong></em>The Pin will hold bodies in place like the object is hanging from it.<br /><br /><strong>maxMotorTorque:</strong> If you enable the motor the maxMotorTorque is used to control how powerful the motor is. The more power the heavier the objects the motor can push / rotate.<br /><em><br /></em><strong>motorSpeed:</strong> You can set the speed and direction of the motor using motorSpeed slider, positive numbers will turn the object clockwise, negative numbers will set the rotation counterclockwise.<br /><br /><strong>enableLimits:</strong> If you want to enable a limit for the rotation you can set an upper or lower limit and the object will stop it&rsquo;s motion once it reaches those values. This is very useful when you want to create swinging axes or pendulums.<br /><br /></li>
	<li><strong><em>Slide:</em><br /></strong> This works similar to the Pin, the difference is that instead of setting a rotating motion it enables horizontal or vertical movements. The settings are also the same as with the Pin the main difference is in the <strong>enableLimits</strong> option which sets horizontal or vertical limits, the direction will depend on the rotation of the object. You can adjust the rotation of the object by clicking it with the pointer/cursor/selection tool.<br /><br /></li>
	<li><strong><em>Distance:</em><br /></strong> A point on each body will be kept at a fixed distance apart with a springy mechanism. This is useful for building things like levers, but can also be used to build trees that can actually bend. If you want to keep an object at a certain angle (like a tree) you can use 2 distance joints next to each other to limit the rotation.<br /><br /><strong>frequencyHz:</strong> is used to set how stiff / springy the object should be. A higher value means a stiffer joint.<br /><br /><strong>damping:</strong> this is used to naturally slow down the movement of the joint<br /><br /></li>
	<li><strong><em>Rope:</em><br /></strong>This pin simulates the effect of a rope, useful for creating hanging bridges or lamps.<br /><br /></li>
	<li><strong><em>Wheel:</em><br /></strong> A joint useful for modelling vehicle suspension. It combines features from both the <em><strong>Pin</strong></em> joint and the <em><strong>Distance</strong></em> joint.<time datetime="2020-10-07T10:49:15.596Z" role="note" aria-label="Wednesday, 7 October 2020 12:49"><br /></time></li>
	</ul>
	<p><strong>Tips:</strong></p>
	<ul>
	...
	art: `<p>The art tool is similar to the free drawing tool, the main difference is that you can only draw graphics with this (not Bodies) but once the object has been drawn, you can select it with the cursor and adjust all it&rsquo;s settings including converting it to a Body!<br />Toggle <em><strong>smoothen</strong></em> to switch between smooth or rough edges.</p>
	<p><strong>Controls:</strong></p>
	...
	<li><span> </span><strong>allObjects</strong><span><br /></span>Triggers if any Body touches</li>
	...
	<p><strong>Controls:</strong></p>
	<ul>
	<li><em><strong>Mouse Click</strong></em> - click any vertice to select it, or drag a square and select multiple</li>
	<li><em><strong>Mouse Drag</strong></em> - moves the vertices if selected</li>
	<li><em><strong>Double Click vertice </strong></em>- when editing a graphics object, double clicking the vertice will enable bezier curves</li>
	<li><em><strong>Double Click no vertice</strong></em>&nbsp;- this will exit vertice editing</li>
	<li><em><strong>BACKSPACE &amp; DELETE</strong> </em>- remove a vertice</li>
	<li><em><strong>ARROWS</strong></em> - moves the selected vertices</li>
	</ul>
	<p><strong>Tips:</strong></p>
	<ul>
