...
class basePrefab{
    ...
    constructor(target){
        ...
        console.log(target.prefabName, target.instanceID);
        this.lookupObject = game.editor.lookupGroups[target.prefabName+"_"+target.instanceID];
...
class character extends basePrefab {
    ...
    initContactListener(){
        ...
        this.contactListener.PostSolve = function (contact, impulse) {
            var targetGroup = self.lookupObject[group];
