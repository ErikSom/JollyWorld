...
function UIManager() {
    ...
    this.buildSocialShare = targetContainer => {
        ...
        let folder = socialShareGUI.addFolder('Social Share Menu');
        folder.domElement.classList.add('custom');
        ...
        let span = document.createElement('span');
        span.innerHTML = 'Level link:'
        divWrapper.appendChild(span);

        const embedDiv = document.createElement('div');
        embedDiv.setAttribute('id', 'socialShareEmbed');
        divWrapper.appendChild(embedDiv);
        ...
        span = document.createElement('span');
        span.innerHTML = 'Or share by:';
        divWrapper.appendChild(span);

        const socialMediaPlaceHolder = document.createElement('div');
        socialMediaPlaceHolder.style.backgroundColor = '#0000005e';
        socialMediaPlaceHolder.style.padding = '5px';
        socialMediaPlaceHolder.style.marginTop = '5px';
        ...
        targetDomElement.appendChild(divWrapper);
        targetContainer.appendChild(socialShareGUI.domElement);
        socialShareGUI.domElement.style.position = 'absolute';
    ...
    this.showSocialShare = function (level) {
        ...
        socialShareScreen.domElement.style.top = '50%';
