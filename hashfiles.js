...
files = files.filter(file => !pngsToDelete.includes(file) && file.indexOf('.DS_Store') < 0 && file.indexOf('/instruments/') < 0 && file.indexOf('awesome-game.js') < 0 && file.indexOf('.ttf') < 0 && path.basename(file).length<30);
