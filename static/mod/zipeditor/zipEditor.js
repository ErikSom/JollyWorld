...
function zipEditorExport(apply = false) {
	...
	for (let [key, value] of Object.entries(zip_loaded_text_files)) {
    	generated_zip.file(key, value)
	}
	for (let [key, value] of Object.entries(zip_loaded_images)) {
...
function saveChanges() {
	...
	if (current_view_type == "Text") {
		...
		zip_loaded_text_files[textarea.getAttribute('path')] = textarea.value;
